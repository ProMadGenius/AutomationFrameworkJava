...
import utilityClasses.GenevaFileUtils;

import java.io.File;
import java.io.IOException;
import java.util.InputMismatchException;

import static core.ConfigReader.*;
...
import static core.ui.ParallelDriver.*;
...
public class BaseTest {
    ...
    public void tearDown(ITestResult result) {
        ...
        if (ITestResult.FAILURE == result.getStatus()) {
            ...
            String screenShotDirectoryPath = GenevaFileUtils.getProjectScreenshotDir();
            GenevaFileUtils.createDirectoryIfNotExist(screenShotDirectoryPath);
